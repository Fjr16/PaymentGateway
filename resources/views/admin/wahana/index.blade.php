        ...
        <div class="col-lg-12">
            ...
            <div class="row my-3">
                ...
                <div class="col-lg-6 text-right">
                    <a class="btn btn-success" href="{{ route('wahana.create') }}">
                        <i class="fas fa-plus"></i> Add Wahana
                    </a>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($wahanas as $wahana)
                                <tr>
                                    ...
                                    <td><img src="{{ url('gambar/wahana/' . $wahana->foto) }}" alt="Product Thumb"
                                            width="100" height="100" /></td>

                                    <td>
                                        <form action="{{ route('wahana.destroy', $wahana->id) }}" method="POST">
                                            <a class="btn btn-primary"
                                                href="{{ route('wahana.edit', $wahana->id) }}">Edit</a>
                                            @csrf
                                            @method('DELETE')
